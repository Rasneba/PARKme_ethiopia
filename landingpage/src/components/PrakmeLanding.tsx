...
const steps = [
  ...
  { num: "02", title: "Reserve & pay instantly", desc: "Pick your duration, pay via ArkWallet or telebirr. Your gate code appears immediately." },
...
const testimonials = [
  ...
  { name: "Tigist M.", role: "Host, Arat Kilo", quote: "My compound sits empty while I'm at work. With Prakme I earn 4,000+ ETB a month from that space.", avatar: "TM" },
    ...
    <div className="lp">
      ...
      <nav className="lp-nav">
        <div className="nav-inner">
          <div className="nav-logo">
            ...
            <div className="logo-text"><b>Prak</b><span>me</span></div>
          </div>
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <FadeIn delay={200}>
            <p className="hero-sub">Prakme connects drivers with verified parking spaces and lets hosts earn from their empty spots. One app. Zero circling.</p>
          </FadeIn>
          <FadeIn delay={300}>
                ...
                <div className="phone-frame">
                  ...
                  <div className="phone-screen">
                    <div className="phone-header">
                      <span className="phone-logo">P</span><span>Prakme</span><span className="phone-dot" />
                    </div>
              ...
              {!registered ? (
                <>
                  <div className="reg-header">
                    ...
                    <h2>Create your <em>Prakme</em> account</h2>
                  ...
                  <form className="reg-form" onSubmit={(e) => void handleRegister(e)}>
                    ...
                    <p className="reg-signin">Already have an account? <a href="#register"><b>Sign in</b></a></p>
                  </form>
                </>
              ) : (
                <div className="reg-success">
                  ...
                  <h2>Welcome to Prakme, <em>{registered.fullName.split(" ")[0]}</em>! 🎉</h2>
                    ...
                    <div className="reg-next-grid">
                      {registered.role === "driver" ? (
                        <>
                          ...
                          <div className="rn-step"><span>2</span><div><b>Reserve a spot</b><p>Pay with ArkWallet or telebirr</p></div></div>
                  ...
                  <button className="reg-submit" onClick={() => { setRegistered(null); setFullName(""); setEmail(""); setPhone(""); setPassword(""); }}>
                    Register another account <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 5v14M5 12h14"/></svg>
                  </button>
                </div>
              )}
            </div>
      ...
      <footer className="lp-footer">
        <div className="footer-inner">
          <div className="footer-brand">
            <div className="nav-logo"><span className="logo-mark">P</span><div className="logo-text"><b>Prak</b><span>me</span></div></div>
        ...
        <div className="footer-bottom"><span>© 2024 Prakme. Made with ❤️ in Addis Ababa, Ethiopia.</span></div>
      </footer>
    </div>
  );
}
